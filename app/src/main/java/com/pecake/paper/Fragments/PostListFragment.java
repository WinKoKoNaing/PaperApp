...
import com.pecake.paper.activities.ActivityCreatePost;
import com.pecake.paper.activities.ActivityPostDetail;
import com.pecake.paper.activities.ActivityProfile;
import com.pecake.paper.helpers.EndlessRecyclerViewScrollListener;
...
public abstract class PostListFragment extends Fragment {
    ...
    // Arrays
    List<String> userBookMarks = new ArrayList<>();
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new FirebaseRecyclerAdapter<Post, PostViewHolder>(options) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull final PostViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull final Post model) {
                ...
                holder.header.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        pos = position;
                        userBookMarks = model.bookMarks;
                        Bundle b = new Bundle();
                        b.putStringArrayList("uids", (ArrayList<String>) userBookMarks);
                        ...
                        Intent postIntent = new Intent(getContext(), ActivityPostDetail.class);
...
//                        onBookMarkClicked(userPostRef);
                ...
                holder.userInfo.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtra(PeCake.USER_ID, model.getUid());
                        startActivity(i);
                    }
                });
...
//        });
    ...
    public void changeRecyclerPosition() {
