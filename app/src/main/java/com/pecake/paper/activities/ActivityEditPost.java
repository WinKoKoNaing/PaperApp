...
public class ActivityEditPost extends AppCompatActivity implements View.OnClickListener {
    ...
    public void getPostData(Post post) {
        ...
        if (post.getPostPhotoUri() != null || !post.getPostPhotoUri().equals("")) {
            ...
            try {
                ...
                Glide.with(ActivityEditPost.this).load(post.getPostPhotoUri()).into(ivMain);
            } catch (Exception e) {
            }
        }
    }
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                ...
                case PICK_IMAGE:
                    ...
                    Glide.with(ActivityEditPost.this).load(selectedImage).into(ivMain);
        ...
        if (selectedImage != null) {
            ...
            uploadTask.addOnSuccessListener(this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    uploadTask.addOnSuccessListener(ActivityEditPost.this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        @Override
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                     ...
                                     uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                                        ...
                                        public void onComplete(@NonNull Task<Uri> task) {
                                            if (task.isSuccessful()) {
                                                ...
                                                post = new Post(title, content, category, postUri.toString(), getCurrentDate(), currentTime, uid, name, userLogoUri, pdetail.countViewer, pdetail.viewers, pdetail.bookMarks, pdetail.starCount, pdetail.stars);
            ...
            post = new Post(title, content, category, getCurrentDate(), currentTime, uid, name, getUserLogoUri(), pdetail.countViewer, pdetail.viewers, pdetail.bookMarks, pdetail.starCount, pdetail.stars);
    ...
    public void alertDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ActivityEditPost.this);
